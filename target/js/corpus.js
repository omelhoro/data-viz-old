...
(function() {
  var Handlers, Session, TextMatrix, TextMatrixViz, filterFunc, load_csv,
  ...
  Session = (function() {
    function Session(data) {
      this.tm = new TextMatrix(data);
      this.view = new TextMatrixViz(this.tm, 600, 600, 80, 50);
      this.viewMenu = new Handlers(this.view, this.tm);
    }
