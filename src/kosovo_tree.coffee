text_tree="<div>
    <p>This site about my participance in a research-project at the <a href='http://www.ifsh.de' >ISHF</a> titeled <a href='http://ifsh.de/projekte/dfg-projekte/i'>'Claiming Respect'</a>. I have worked six months on the Kosovo-Case, not only the bombings March-Juny 1999 but also the forerun 1998 and the post-war period.</p>
    <p>
